...
class IMG_Generator():
    def __init__(self):
        ...
        for old_img in self.list_images_unparsed:
            if (old_img[:old_img.index(".ppm")] + ".json") not in self.list_images_parsed:
                self.read_image("images/"+old_img)
            else:
    ...
    def show_picture(self,json_path):
